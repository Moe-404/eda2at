...
ALTER TABLE books ADD COLUMN IF NOT EXISTS publisher VARCHAR(255) DEFAULT 'دار نشر سبيل الإضاءات';
ALTER TABLE books ADD COLUMN IF NOT EXISTS language VARCHAR(100) DEFAULT 'العربية';
